...
exports.seed = function(req, res) {
    ...
    var schedules = [
        ...
        new Schedule({
            ...
            date: getDateNow(),
            doctor: hospitalEmployees[1]._id,
            appointments: [appointments[0]._id,appointments[2]._id,appointments[4]._id,appointments[5]._id,appointments[6]._id]
        }),
        new Schedule({
            timePeriod: 'pm',
            date: getDateNow(),
            doctor: hospitalEmployees[1]._id,
            appointments: [appointments[1]._id,appointments[3]._id,appointments[8]._id]
        })
    ];

        ...
        this.elementService.getDoctorDateElements().then((jsonObject) => {
           jsonObject.forEach((e)=>{
            //    (e["_id"]["period"] == "am")
                this.events.push(
                    {
                        title  : `<i class="fa fa-circle left-event" aria-hidden="true"><span class="text-primary">      ${e.doctors}/5</span></i> <i class="fa fa-circle right-event" aria-hidden="true">      ${e.patients}/15</i>`,
